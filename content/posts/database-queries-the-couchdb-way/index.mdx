...
date: 2009-06-30
slug: /2009/06/30/database-queries-the-couchdb-way.html
tags:
  - CouchDB
revisions:
  - date: 2009-07-05
    message: Updated examples to demonstrate that CouchDB stores indexes sorted by key. Thanks to J. Chris Anderson for pointing that out.
  - date: 2009-08-06
    message: Added link to full text search implementation on CouchDB wiki.
  - date: 2009-08-09
