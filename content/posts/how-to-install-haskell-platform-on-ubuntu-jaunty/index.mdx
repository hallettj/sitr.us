...
date: 2009-07-02
slug: /2009/07/02/how-to-install-haskell-platform-on-ubuntu-jaunty.html
tags:
  - Haskell
revisions:
  - date: 2009-07-23
    message: Added zlib1g-dev to list of build dependencies. Thanks Jack Siler and Fernand.
  - date: 2009-08-01
    message: Added step for installing checkinstall. Thanks Paulo.
---
