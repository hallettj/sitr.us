...
date: 2008-07-29
slug: /2008/07/29/how-to-use-rspec-to-describe-a-sinatra-application.html
tags:
  - Ruby
revisions:
  - date: 2008-10-11
    message: "The Sinatra application that led to this article is now open source and is available at [http://github.com/hallettj/restful_captcha](http://github.com/hallettj/restful_captcha). If you want to see the RSpec techniques that I used in context, check out the code there."
  - date: 2009-08-09
    message: This article is pretty outdated. Added a note to that effect.
---
