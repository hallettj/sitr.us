...
date: 2017-02-21
slug: /2017/02/21/changes-i-would-make-to-go.html
comments: true
revisions:
  - date: 2017-03-19
    message: Correct inaccuracies regarding `nil`, slice type manipulation, and `make`; add discussion of zero values; lots of edits
  - date: 2017-03-20
    message: Add link to The Language I Wish Go Was
  - date: 2017-03-20
    message: Change one instance of "nullable" to "non-nullable"; edit to conclusion section
  - date: 2017-03-20
    message: Edits based on reader feedback
---
