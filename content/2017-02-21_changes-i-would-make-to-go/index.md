...
description = "To highlight exactly how I think Go could be better, I want to make comparisons to Rust."
date = 2017-02-21
updated = 2017-03-20
path = "2017/02/21/changes-i-would-make-to-go.html"
...
[extra]
revisions = [
  { date = 2017-03-19, message = "Correct inaccuracies regarding `nil`, slice type manipulation, and `make`; add discussion of zero values; lots of edits" },
  { date = 2017-03-20, message = "Add link to The Language I Wish Go Was" },
  { date = 2017-03-20, message = "Change one instance of \"nullable\" to \"non-nullable\"; edit to conclusion section" },
  { date = 2017-03-20, message = "Edits based on reader feedback" },
]
+++
...
Rust aims for soundness,[^1] powerful abstractions, and high performance;
