# I copied and modified the zola expression from nixpkgs to build the latest
# version of zola
#
# see https://github.com/NixOS/nixpkgs/blob/nixos-unstable/pkgs/by-name/zo/zola/package.nix
#
# I made the following changes:
# - version
# - hash argument to fetchFromGitHub
# - cargaHash
